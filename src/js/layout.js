export default class Layout {
  constructor() {
    ...
    this.description = 'Описание новостного ресурса';
  }
  ...
  renderError() {
    ...
    this.errorEl.style.width = `${
      document.querySelector('.news').offsetWidth
    }px`;
    this.errorEl.style.height = `${
      document.querySelector('.news').offsetHeight
    }px`;
